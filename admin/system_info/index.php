		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					...
					<input type="text" class="form-control form-control-sm" name="bank" id="bank" value="<?php echo  $_settings->info('bank') ?>">
				</div>
				<div class="form-group">
					<label for="bank_holder" class="control-label">Bank Holder Name</label>
					<input type="text" class="form-control form-control-sm" name="bank_holder" id="bank_holder" value="<?php echo  $_settings->info('bank_holder') ?>">
				</div>
				<div class="form-group">
					<label for="bank_acc" class="control-label">Bank Account No.</label>
					<input type="text" class="form-control form-control-sm" name="bank_acc" id="bank_acc" value="<?php echo  $_settings->info('bank_acc') ?>">
				</div>
			<div class="form-group">
