							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
								  	<p class="dropdown-item edit_data"   onclick="showInvoice(<?php echo $row['id'] ?>)"><span class="fa fa-edit text-primary"></span>View Invoice</p>
...
<script>
	...
	function showInvoice(id){
		var nw = window.open("./invoice/print.php?id="+id,"_blank","width=993,height=1045")
		// setTimeout(()=>{
		// 	// nw.print()
		// 	setTimeout(()=>{
		// 		nw.close()
